                        ...
                        return t(
                            ...
                            [
                                t("div", { staticClass: "custom-block tip" }, [
                                    t("p", [
                                        s._v(
                                            "最近在给公司架构一个新的项目，要求同时写出一个完整的文档，由于正好在浏览vue的GitHub浏览相关项目时，看到了 "
                                        ),
                                        t("code", [s._v("Vuepress")]),
                                        s._v(
                                    ...
                                    [
                                        t(
                                            "a",
                                            {
                                                ...
                                                attrs: {
                                                    href: "#gitlab-pages-原理",
                                                },
                                            },
                                            [s._v("#")]
                                        ),
                                        s._v(" GitLab Pages 原理"),
                                    ]
                                ),
                                s._v(" "),
                                t("p", [
                                    s._v(
                                        "首先了解一下GitLab Pages运行的原理。与GitHub不同的是，GitLab需要上传一个 "
                                    ),
                                    t("code", [s._v(".gitlab-ci.yml")]),
                                    s._v(
                                        " 的文件，同时生成的项目文件必须要到 "
                                    ),
                                    t("code", [s._v("/public")]),
                                ...
                                t(
                                    ...
                                    {
                                        staticClass:
                                            "language-yml line-numbers-mode",
                                    },
                                    [
                                        t(
                                            "pre",
                                ...
                                t("p", [
                                    s._v("郑重推荐 "),
                                    t("strong", [s._v("vuepress-theme-reco")]),
                                    s._v(" ，查看 "),
                                    t(
                                        "a",
                                        {
                                        ...
                                        [s._v("展示"), t("OutboundLink")],
                                        1
                                    ),
                                    s._v(
                                        " 既没有脱离默认主题的简洁，又增加了分类、分页、标签等功能。"
                                    ),
                                ]),
                                s._v(" "),
                                t(
