...
3. 一些自用的油猴脚本 [github address](https://github.com/wangrongding/ding-script.git)
4. ding-trans(终端翻译程序) [github address](https://github.com/wangrongding/ding-script.git)
